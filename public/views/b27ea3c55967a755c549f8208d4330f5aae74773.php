...
<head>
    ...
    <!-- Scripts -->
    <!-- src="<?php echo e(mix('js/app.js'), false); ?>" -->
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(url('admin/'), false); ?>"><?php echo e(__('Admin'), false); ?></a>
                            </li>
...
<?php /**PATH D:\wamp64\www\laravel\laravel_todo_fullstack\public\views/layouts/app.blade.php ENDPATH**/ ?>